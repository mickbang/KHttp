...
public final class Utils {
    ...
    private static String getDiskFilesDir() {
        return isSDCardExist() && KHttp.getContext().getExternalFilesDir(null) != null ? KHttp.getContext().getExternalFilesDir(null).getPath() : KHttp.getContext().getFilesDir().getPath();
    }
